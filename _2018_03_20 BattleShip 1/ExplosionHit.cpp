...
ExplosionHit::ExplosionHit(const D3DXVECTOR3& pos)
	: m_pos(pos)
...
void ExplosionHit::Render()
{
	Texture* tex = GetTex(L"ExplosionHit" + std::to_wstring(m_frame));
