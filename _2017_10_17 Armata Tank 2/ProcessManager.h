...
public:
	...
	void SetFunction(bool(*initialize)(), void(*update)(double), bool(*render)(), bool(*release)()) { m_initialize = initialize; m_update = update; m_render = render; m_release = release; }
